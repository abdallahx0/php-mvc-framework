...
class Loader
{
	...
	public function __construct(Application $app)
	{
	 ...
	 /**
	 * Call the given controller with given method
	 * and pass the given argument to the controller method
	 *
	...
	private function addController($controller)
	{
		...
		// Home will be :
		// App\Controllers\HomeController (for example)
	...
	private function addModel($model)
	{
            ...
            // App\Models\HomeModel (for example)
